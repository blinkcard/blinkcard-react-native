...
- The whole integration process can be found in the sample app `App.tsx` file [here](https://github.com/BlinkCard/blinkcard-react-native/blob/main/sample_files/App.tsx).
...
The BlinkCard module implementation is located in the `src` folder [here](https://github.com/BlinkCard/blinkcard-react-native/tree/main/BlinkCard/src), while platform-specific implementation is located in the `android` and `ios` folders.
...
1. [BlinkCard SDK settings](https://github.com/BlinkCard/blinkcard-react-native/blob/main/BlinkCard/src/blinkCardSettings.ts#L12) - `BlinkCardSdkSettings` \
...
2. [BlinkCard Session settings](https://github.com/BlinkCard/blinkcard-react-native/blob/main/BlinkCard/src/blinkCardSettings.ts#L95) - `BlinkCardSessionSettings`\
...
3. [Scanning settings](https://github.com/BlinkCard/blinkcard-react-native/blob/main/BlinkCard/src/blinkCardSettings.ts#L129) - `ScanningSettings`\
...
4. [Liveness settings](https://github.com/BlinkCard/blinkcard-react-native/blob/main/BlinkCard/src/blinkCardSettings.ts#L227) - `LivenessSettings`\
...
5. [Extraction settings](https://github.com/BlinkCard/blinkcard-react-native/blob/main/BlinkCard/src/blinkCardSettings.ts#L304) - `ExtractionSettings`\
...
6. [Anonymization settings](https://github.com/BlinkCard/blinkcard-react-native/blob/main/BlinkCard/src/blinkCardSettings.ts#L374) - `AnonymizationSettings`\
Holds the settings which control the anonymization of returned data.

7. [Cropped image settings](https://github.com/BlinkCard/blinkcard-react-native/blob/main/BlinkCard/src/blinkCardSettings.ts#L433) - `CroppedImageSettings`\
...
8. [Scanning UX settings](https://github.com/BlinkCard/blinkcard-react-native/blob/main/BlinkCard/src/blinkCardSettings.ts#L475) - `ScanningUxSettings`\
...
- The [blinkCardSettings.ts](https://github.com/BlinkCard/blinkcard-react-native/blob/main/BlinkCard/src/blinkCardSettings.ts) file contains all the settings that can be modified and explains what each setting does in more detail.
...
- The native Kotlin & Swift implementation of all BlinkCard settings can be found here for [Android](https://github.com/blinkcard/blinkcard-react-native/blob/main/BlinkCard/android/src/main/java/com/microblink/blinkcard/reactnative/serialization/BlinkCardDeserializationUtils.kt) & [iOS](https://github.com/blinkcard/blinkcard-react-native/blob/main/BlinkCard/ios/Serialization/BlinkCardDeserializationUtils.swift) in the BlinkCard deserialization utilities.
...
- The [blinkCardResult.ts](https://github.com/BlinkCard/blinkcard-react-native/blob/main/BlinkCard/src/blinkCardResult.ts) file contains all the results that can be obtained and explains what each result represents in more detail.
...
- The native Kotlin & Swift implementation of all BlinkCard results can be found here for [Android](https://github.com/blinkcard/blinkcard-react-native/blob/main/BlinkCard/android/src/main/java/com/microblink/blinkcard/reactnative/serialization/BlinkCardSerializationUtils.kt) & [iOS](https://github.com/blinkcard/blinkcard-react-native/blob/main/BlinkCard/ios/Serialization/BlinkCardSerializationUtils.swift) in the BlinkCard serialization utilities.
